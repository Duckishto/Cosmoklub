...
async function finishLesson(){
  if(typeof completeLesson==='function'){
    try{
      // completeLesson() is async — for signed-in users it's a network
      // round trip to the complete_lesson() Supabase function, so this is
      // awaited before navigating away or the request could be cancelled
      // mid-flight.
      ...
      console.error(
        'CosmoKlub lesson completion could not be saved:',
        error
      );
    }
  }else{
