...
const PERSONAS = {
  student: {
    ...
    titleTop: 'Learn astronomy the way',
  ...
  professor: {
    ...
    titleTop: 'Run your course and your class',
  ...
  tutor: {
    ...
    eyebrow: 'For tutors',
    titleTop: 'Run sharper sessions with material',
    titleAccent: 'that is ready to go',
  ...
  hobbyist: {
    ...
    titleAccent: 'what you actually saw',
