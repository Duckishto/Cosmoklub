...
const GRAPH_KEY_SETS = {
  basic: [
    ...
    { label: '0' }, { label: '.' }, { label: '=', token: '=' }, { label: '+', token: '+', tone: 'operator' }, { label: 'xʸ', token: '^', tone: 'operator' },
  ],
  functions: [
    { label: '(', token: '(' }, { label: ')', token: ')' }, { label: '√', token: 'sqrt(' }, { label: '∛', token: 'cbrt(' }, { label: '|x|', token: 'abs(' },
    { label: 'ln', token: 'ln(' }, { label: 'log', token: 'log(' }, { label: 'eˣ', token: 'exp(' }, { label: 'floor', token: 'floor(' }, { label: 'round', token: 'round(' },
    { label: 'π', token: 'π' }, { label: 'e', token: 'e' }, { label: 'a', token: 'a' }, { label: 'b', token: 'b' }, { label: ',', token: ',' },
    { label: 'x', token: 'x' }, { label: 'y', token: 'y' }, { label: '=', token: '=' }, { label: '^', token: '^', tone: 'operator' }, { label: '×', token: '×', tone: 'operator' },
  ],
  trig: [
