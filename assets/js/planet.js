...
// Base folder for all 3D planet models — add a new model by dropping the
// .glb file in assets/models/ and adding its filename below, nothing else
// needs to change.
...
const PLANET_MODELS = [
  ...
  'Uranus.glb',
  'Neptune.glb',
  // add more models here as needed (filename only, e.g. 'Pluto.glb')
].map(name => MODEL_BASE + name);
