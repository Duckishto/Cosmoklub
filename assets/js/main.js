  ...
  computed: {
      ...
      return [
        {
          ...
          bullets: [
            ...
            { svg: SVGS.satellite, text: 'Set your experience level' },
            { svg: SVGS.layers, text: 'Track your lessons and progress' }
          ]
        },
        {
          ...
          bullets: [
            ...
            { svg: SVGS.cpu, text: 'Explore celestial objects' },
            { svg: SVGS.book, text: 'Save discoveries and notes' }
          ]
        },
        {
          ...
          bullets: [
            ...
            { svg: SVGS.layers, text: 'Use interactive astronomy tools' },
            { svg: SVGS.chart, text: 'Share questions and discoveries' }
          ]
        }
      ];
    },
    manage() {
      const panel = {
        ...
        img: '',
        desc: 'Invite learners individually or import a member list by CSV. CosmoKlub keeps profiles, course access, and learning progress organized in one place.',
        bullets: [
    ...
    plans() {
      return [
        {
          name: 'Explorers',
          tagline: 'Everything you need to begin exploring astronomy.',
          free: true,
          popular: false,
          cta: 'Get started',
          features: [
            'Access to 2 learning courses',
            'Core astronomy lessons',
            'Basic learning roadmaps',
            'Community forum access',
            'Personal observation logbook',
            'Essential astronomy resources'
          ]
        },
        {
          name: 'Lite',
          tagline: 'Everything in Explorers, plus:',
          monthly: 840, yearly: 758,
          popular: false,
          cta: 'Get started',
          features: [
            'Access to 5 learning courses',
            'Expanded lesson library',
            'Progress and XP tracking',
            'Observation planning tools',
            'Saved celestial objects and notes',
        ...
        },
        {
          ...
          cta: 'Get started',
          features: [
            'Access to 25 learning courses',
            'Advanced astronomy roadmaps',
        ...
        },
        {
          ...
          cta: 'Contact us',
          features: [
            'Custom course and learner limits',
            'Classroom and team management',
            'Bulk member import',
            'Organization progress reporting',
      ...
      return [
        {
          ...
          a: 'CosmoKlub is an astronomy learning and observation platform. It combines structured learning roadmaps with an object browser, Astronomy Picture of the Day, media gallery, function grapher, 3D planetarium, community forum, and observation tools.'
        },
        {
          q: 'Do I need any technical background to get started?',
          a: 'No. CosmoKlub is designed for complete beginners as well as experienced astronomy enthusiasts. The learning roadmaps introduce each topic step by step, while advanced tools remain available whenever you are ready to explore further.'
        },
        {
          q: 'How long does it take to set everything up?',
          a: 'Creating an account and setting up your profile should take only a few minutes. After that, you can immediately choose a learning category, begin a lesson, explore celestial objects, or join a community discussion.'
        },
        {
          q: 'Can I import my existing data and content?',
          a: 'Supported accounts can add members individually or import a member list by CSV. If you need to migrate a larger classroom, organization, or existing astronomy project, contact the CosmoKlub team for assistance.'
        },
        {
          q: 'Is there a free trial, and how do I cancel?',
          a: 'The Explorers plan allows you to begin using CosmoKlub at no cost. Pricing and billing periods are shown before selecting a paid plan, and you can contact CosmoKlub support whenever you need help with billing or cancellation.'
        }
      ];
    },
    demoMonthLabel() {
