...
const translations = {
  EN: {
    ...
    privacy1Body: 'We collect information you provide directly, such as your name, email address, and password when you register, as well as content you create within the Service (observations, logbook entries, chat messages). We also automatically collect usage data, device information, and approximate location to improve and personalise your experience.',
    privacy2Title: 'How We Use Your Information',
    privacy2Body: 'Your information is used to operate and maintain your account, personalise your dashboard and recommendations, respond to support requests, send service-related notifications, and improve the platform through aggregated, anonymised analytics. We do not use your personal data for purposes unrelated to providing and improving CosmoKlub.',
    privacy3Title: 'Cookies & Tracking Technologies',
    privacy3Body: 'CosmoKlub uses essential cookies to keep you signed in and remember your preferences (such as language), and optional analytics cookies to understand how the Service is used. You can disable non-essential cookies at any time through your browser settings; doing so may limit some features.',
    privacy4Title: 'Data Sharing & Third Parties',
    privacy4Body: 'We never sell your personal information. Limited data may be shared with trusted service providers who help us operate the platform (such as hosting and email delivery), and these providers are bound by confidentiality obligations. We may also disclose information if required by law or to protect the rights and safety of our users.',
    privacy5Title: 'AI Features & Data Processing',
    privacy5Body: 'Content you submit to AI-powered features, such as Pensia or AI Object Recognition (e.g., uploaded photos or questions), may be processed by third-party model providers solely to generate a response. This content is not used to build user profiles, and is not retained by CosmoKlub beyond what is necessary for the session.',
    privacy6Title: 'Your Rights & Data Retention',
    privacy6Body: 'You may access, correct, export, or delete your personal data at any time by contacting hello@cosmoklub.space or through your account settings. We retain your data only for as long as your account is active or as needed to comply with legal obligations; deleting your account permanently removes your personal information from our active systems.',
  ...
  ES: {
    ...
    privacyDate: 'Junio 2026',
    privacy1Title: 'Informacion que Recopilamos',
    privacy1Body: 'Recopilamos la informacion que nos proporcionas directamente, como tu nombre, correo electronico y contrasena al registrarte, asi como el contenido que creas en el Servicio (observaciones, entradas de bitacora, mensajes de chat). Tambien recopilamos automaticamente datos de uso, informacion del dispositivo y ubicacion aproximada para mejorar y personalizar tu experiencia.',
    privacy2Title: 'Como Usamos tu Informacion',
    privacy2Body: 'Tu informacion se utiliza para operar y mantener tu cuenta, personalizar tu panel y recomendaciones, responder solicitudes de soporte, enviar notificaciones relacionadas con el Servicio y mejorar la plataforma mediante analisis agregados y anonimos. No usamos tus datos personales para fines ajenos a ofrecer y mejorar CosmoKlub.',
    privacy3Title: 'Cookies y Tecnologias de Seguimiento',
    privacy3Body: 'CosmoKlub utiliza cookies esenciales para mantener tu sesion iniciada y recordar tus preferencias (como el idioma), y cookies de analitica opcionales para entender como se usa el Servicio. Puedes desactivar las cookies no esenciales en cualquier momento desde la configuracion de tu navegador; esto puede limitar algunas funciones.',
    privacy4Title: 'Compartir Datos y Terceros',
    privacy4Body: 'Nunca vendemos tu informacion personal. Es posible que compartamos datos limitados con proveedores de confianza que nos ayudan a operar la plataforma (como alojamiento y envio de correos), quienes estan sujetos a obligaciones de confidencialidad. Tambien podemos divulgar informacion si la ley lo exige o para proteger los derechos y la seguridad de nuestros usuarios.',
    privacy5Title: 'Funciones de IA y Procesamiento de Datos',
    privacy5Body: 'El contenido que envias a funciones con IA, como Pensia o el Reconocimiento de Objetos con IA (por ejemplo, fotos o preguntas), puede ser procesado por proveedores externos unicamente para generar una respuesta. Este contenido no se usa para crear perfiles de usuario y no se conserva mas alla de lo necesario para la sesion.',
    privacy6Title: 'Tus Derechos y Conservacion de Datos',
    privacy6Body: 'Puedes acceder, corregir, exportar o eliminar tus datos personales en cualquier momento escribiendo a hello@cosmoklub.space o desde la configuracion de tu cuenta. Conservamos tus datos solo mientras tu cuenta este activa o segun lo exija la ley; eliminar tu cuenta borra permanentemente tu informacion personal de nuestros sistemas activos.',
  ...
  FR: {
    ...
    privacyDate: 'Juin 2026',
    privacy1Title: 'Informations que Nous Collectons',
    privacy1Body: "Nous collectons les informations que vous nous fournissez directement, telles que votre nom, votre e-mail et votre mot de passe lors de l'inscription, ainsi que le contenu que vous creez dans le Service (observations, entrees de journal, messages de chat). Nous collectons egalement automatiquement des donnees d'utilisation, des informations sur l'appareil et une localisation approximative afin d'ameliorer et de personnaliser votre experience.",
    privacy2Title: 'Comment Nous Utilisons vos Informations',
    privacy2Body: "Vos informations servent a faire fonctionner et a maintenir votre compte, a personnaliser votre tableau de bord et vos recommandations, a repondre aux demandes d'assistance, a envoyer des notifications liees au Service et a ameliorer la plateforme grace a des analyses agregees et anonymisees. Nous n'utilisons pas vos donnees personnelles a des fins non liees a la fourniture et a l'amelioration de CosmoKlub.",
    privacy3Title: 'Cookies et Technologies de Suivi',
    privacy3Body: "CosmoKlub utilise des cookies essentiels pour vous maintenir connecte et memoriser vos preferences (comme la langue), ainsi que des cookies d'analyse facultatifs pour comprendre l'utilisation du Service. Vous pouvez desactiver les cookies non essentiels a tout moment dans les parametres de votre navigateur ; cela peut limiter certaines fonctionnalites.",
    privacy4Title: 'Partage des Donnees et Tiers',
    privacy4Body: "Nous ne vendons jamais vos informations personnelles. Des donnees limitees peuvent etre partagees avec des prestataires de confiance qui nous aident a exploiter la plateforme (hebergement, envoi d'e-mails), lesquels sont soumis a des obligations de confidentialite. Nous pouvons egalement divulguer des informations si la loi l'exige ou pour proteger les droits et la securite de nos utilisateurs.",
    privacy5Title: "Fonctionnalites IA et Traitement des Donnees",
    privacy5Body: "Le contenu que vous soumettez aux fonctionnalites alimentees par l'IA, comme Pensia ou la Reconnaissance d'Objets par IA (photos ou questions, par exemple), peut etre traite par des fournisseurs tiers uniquement pour generer une reponse. Ce contenu n'est pas utilise pour creer des profils utilisateurs et n'est pas conserve au-dela de ce qui est necessaire pour la session.",
    privacy6Title: 'Vos Droits et la Conservation des Donnees',
    privacy6Body: "Vous pouvez acceder a vos donnees personnelles, les corriger, les exporter ou les supprimer a tout moment en ecrivant a hello@cosmoklub.space ou via les parametres de votre compte. Nous conservons vos donnees uniquement aussi longtemps que votre compte est actif ou que la loi l'exige ; la suppression de votre compte efface definitivement vos informations personnelles de nos systemes actifs.",
  ...
  JA: {
    ...
    privacy1Body: '登録時に入力される氏名、メールアドレス、パスワードなど、お客様が直接提供する情報、およびサービス内で作成されるコンテンツ（観測記録、ログ、チャットメッセージ）を収集します。また、エクスペリエンスの向上とパーソナライズのために、利用データ、デバイス情報、おおよその位置情報を自動的に収集します。',
    privacy2Title: '情報の利用方法',
    privacy2Body: 'お客様の情報は、アカウントの運営と維持、ダッシュボードとおすすめのパーソナライズ、サポート対応、サービス関連の通知の送信、および集計・匿名化された分析によるプラットフォームの改善に使用されます。CosmoKlubの提供と改善に関係のない目的で個人データを使用することはありません。',
    privacy3Title: 'クッキーと追跡技術',
    privacy3Body: 'CosmoKlubはログイン状態の維持や言語などの設定を記憶するために必須クッキーを使用し、サービスの利用状況を把握するために任意の分析用クッキーを使用します。ブラウザの設定からいつでも必須でないクッキーを無効にできますが、一部機能が制限される場合があります。',
    privacy4Title: 'データの共有と第三者',
    privacy4Body: '個人情報を販売することは一切ありません。ホスティングやメール配信などプラットフォーム運営を支援する信頼できるサービス提供者と限定的なデータを共有することがあり、これらの提供者は機密保持義務を負います。法律で要求される場合、またはユーザーの権利と安全を保護するために情報を開示することもあります。',
    privacy5Title: 'AI機能とデータ処理',
    privacy5Body: 'PensiaやAI天体認識などのAI機能に送信されたコンテンツ（アップロードした写真や質問など）は、応答を生成する目的のみで第三者のモデルプロバイダーが処理する場合があります。このコンテンツはユーザープロファイルの作成には使用されず、セッションに必要な期間を超えて保持されません。',
    privacy6Title: 'お客様の権利とデータの保持',
    privacy6Body: 'hello@cosmoklub.spaceへの連絡またはアカウント設定から、いつでも個人データへのアクセス、修正、エクスポート、削除が可能です。データはアカウントが有効な間、または法的義務を遵守するために必要な期間のみ保持されます。アカウントを削除すると、個人情報は当社のアクティブなシステムから完全に削除されます。',
  ...
  TH: {
    ...
    privacyDate: 'มิถุนายน 2026',
    privacy1Title: 'ข้อมูลที่เราเก็บรวบรวม',
    privacy1Body: 'เราเก็บรวบรวมข้อมูลที่คุณให้กับเราโดยตรง เช่น ชื่อ อีเมล และรหัสผ่านเมื่อคุณลงทะเบียน รวมถึงเนื้อหาที่คุณสร้างขึ้นภายในบริการ (การสังเกต บันทึกประจำวัน ข้อความแชท) เรายังเก็บข้อมูลการใช้งาน ข้อมูลอุปกรณ์ และตำแหน่งโดยประมาณโดยอัตโนมัติเพื่อปรับปรุงและปรับแต่งประสบการณ์ของคุณ',
    privacy2Title: 'วิธีที่เราใช้ข้อมูลของคุณ',
    privacy2Body: 'ข้อมูลของคุณถูกใช้เพื่อดำเนินการและดูแลบัญชีของคุณ ปรับแต่งแดชบอร์ดและคำแนะนำ ตอบกลับคำขอการสนับสนุน ส่งการแจ้งเตือนที่เกี่ยวข้องกับบริการ และปรับปรุงแพลตฟอร์มผ่านการวิเคราะห์ข้อมูลที่รวมกันและไม่ระบุตัวตน เราไม่ใช้ข้อมูลส่วนบุคคลของคุณเพื่อจุดประสงค์อื่นที่ไม่เกี่ยวข้องกับการให้บริการและปรับปรุง CosmoKlub',
    privacy3Title: 'คุกกี้และเทคโนโลยีติดตาม',
    privacy3Body: 'CosmoKlub ใช้คุกกี้ที่จำเป็นเพื่อให้คุณเข้าสู่ระบบและจดจำการตั้งค่าของคุณ (เช่นภาษา) และคุกกี้วิเคราะห์แบบเลือกได้เพื่อทำความเข้าใจการใช้งานบริการ คุณสามารถปิดใช้งานคุกกี้ที่ไม่จำเป็นได้ตลอดเวลาผ่านการตั้งค่าเบราว์เซอร์ ซึ่งอาจจำกัดบางฟีเจอร์',
    privacy4Title: 'การแบ่งปันข้อมูลและบุคคลที่สาม',
    privacy4Body: 'เราจะไม่ขายข้อมูลส่วนบุคคลของคุณ ข้อมูลบางส่วนอาจถูกแบ่งปันกับผู้ให้บริการที่เชื่อถือได้ซึ่งช่วยเราดำเนินงานแพลตฟอร์ม (เช่นการโฮสต์และการส่งอีเมล) ซึ่งผู้ให้บริการเหล่านี้มีข้อผูกพันด้านการรักษาความลับ เราอาจเปิดเผยข้อมูลหากกฎหมายกำหนดหรือเพื่อปกป้องสิทธิ์และความปลอดภัยของผู้ใช้ของเรา',
    privacy5Title: 'ฟีเจอร์ AI และการประมวลผลข้อมูล',
    privacy5Body: 'เนื้อหาที่คุณส่งให้กับฟีเจอร์ที่ใช้ AI เช่น Pensia หรือการจดจำวัตถุด้วย AI (เช่น รูปภาพหรือคำถามที่อัปโหลด) อาจถูกประมวลผลโดยผู้ให้บริการโมเดลบุคคลที่สามเพื่อสร้างคำตอบเท่านั้น เนื้อหานี้ไม่ถูกใช้เพื่อสร้างโปรไฟล์ผู้ใช้ และจะไม่ถูกเก็บไว้เกินกว่าที่จำเป็นสำหรับเซสชัน',
    privacy6Title: 'สิทธิ์ของคุณและการเก็บรักษาข้อมูล',
    privacy6Body: 'คุณสามารถเข้าถึง แก้ไข ส่งออก หรือลบข้อมูลส่วนบุคคลของคุณได้ตลอดเวลาโดยติดต่อ hello@cosmoklub.space หรือผ่านการตั้งค่าบัญชีของคุณ เราเก็บข้อมูลของคุณไว้เพียงเท่าที่บัญชีของคุณยังคงเปิดใช้งานหรือตามที่กฎหมายกำหนด การลบบัญชีของคุณจะลบข้อมูลส่วนบุคคลของคุณออกจากระบบที่ใช้งานอยู่ของเราอย่างถาวร',
