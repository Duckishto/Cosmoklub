...
const Library = {
  ...
  data() {
    return {
      ...
      lessons: [
        { id: 'stars', title: 'Stars', desc: 'Birth, life, and death of stars from protostars to supernovae.', completedLessons: 9, totalLessons: 20, level: 9, xp: 1240, rank: 'GOLD', tierClass: 'tier-gold', quizUnlocked: true, nextUnlocked: true, nextLabel: 'Next: Stellar evolution', svg: '<svg viewBox="0 0 24 24" fill="#facc15"><path d="m12 2 2.9 6.15 6.6.8-4.85 4.5 1.25 6.55L12 16.75 6.1 20l1.25-6.55-4.85-4.5 6.6-.8L12 2z"/></svg>' },
        { id: 'galaxies', title: 'Galaxies', desc: 'Island universes: spirals, ellipticals, and the Milky Way.', completedLessons: 18, totalLessons: 20, level: 18, xp: 2860, rank: 'DIAMOND', tierClass: 'tier-diamond', quizUnlocked: true, nextUnlocked: true, nextLabel: 'Next: Galaxy mergers', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="#38bdf8" stroke-width="1.7" stroke-linecap="round"><path d="M4 14c4.8-7.4 12.3-8 16-2.8"/><path d="M3 18c5-3.8 12-3.5 18 1"/><path d="M7 9c3.2 3.4 6.8 4 10.8 1.5"/></svg>' },
        { id: 'cosmology', title: 'Cosmology', desc: 'The origin, evolution, and fate of the universe.', completedLessons: 17, totalLessons: 20, level: 17, xp: 2710, rank: 'DIAMOND', tierClass: 'tier-diamond', quizUnlocked: true, nextUnlocked: true, nextLabel: 'Next: Dark energy', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="#c084fc" stroke-width="1.6" stroke-linecap="round"><path d="M12 3v18"/><path d="M4 12h16"/><path d="m5 5 14 14"/><path d="m19 5-14 14"/><circle cx="12" cy="12" r="2.2"/></svg>' },
        { id: 'planets', title: 'Planets', desc: "Our solar system's worlds and the hunt for exoplanets.", completedLessons: 13, totalLessons: 20, level: 13, xp: 1980, rank: 'PLATINUM', tierClass: 'tier-platinum', quizUnlocked: true, nextUnlocked: true, nextLabel: 'Next: Exoplanet detection', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="#fb923c" stroke-width="1.6" stroke-linecap="round"><circle cx="12" cy="12" r="5.2"/><path d="M3.2 14.2c2.8 2.2 9.4 1.7 14.6-1.1 2.1-1.1 3.2-2.3 3-3.2-.3-1.1-2.6-1.2-5.5-.4"/></svg>' },
        { id: 'nebulae', title: 'Nebulae', desc: 'Cosmic clouds where stars and planets are forged.', completedLessons: 14, totalLessons: 20, level: 14, xp: 2075, rank: 'PLATINUM', tierClass: 'tier-platinum', quizUnlocked: true, nextUnlocked: true, nextLabel: 'Next: Star-forming regions', svg: '<svg viewBox="0 0 24 24" fill="none"><path d="M7 15.5c-2.2 0-4-1.3-4-3.2 0-1.7 1.4-3 3.2-3.2C7 6.8 9.2 5.5 11.7 6c1.7.3 3.1 1.4 3.8 2.9.4-.1.8-.2 1.3-.2 2.3 0 4.2 1.5 4.2 3.5s-1.9 3.4-4.2 3.4H7z" fill="#d8b4fe"/><circle cx="9" cy="11" r="1" fill="#fff"/><circle cx="15" cy="13" r="1.2" fill="#fff"/></svg>' },
        { id: 'observing', title: 'Observing', desc: 'Tips for naked-eye, binocular, and telescope astronomy.', completedLessons: 8, totalLessons: 20, level: 8, xp: 1135, rank: 'GOLD', tierClass: 'tier-gold', quizUnlocked: true, nextUnlocked: false, nextLabel: 'Pass quiz to unlock next', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="#fde68a" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M9 4 3 16"/><path d="m6 10 9 4"/><path d="m11 5 9 4"/><path d="m15 14 3 6"/><path d="M12 13 9 20"/><path d="M16 8l2-4"/></svg>' }
      ]
    };
  },
  computed: {
